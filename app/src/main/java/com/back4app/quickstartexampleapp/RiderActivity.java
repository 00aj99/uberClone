                                        ...
                                        if(distanceInKm < 0.01){
                                            ...
                                            handler.postDelayed(new Runnable() {
                                                ...
                                                public void run() {
                                                    ...
                                                    csllTaxiButton.setVisibility(View.VISIBLE);
                                                    csllTaxiButton.setText("Call Taxi");
                                                    requestActive=false;
                                                    driverActive = false;
                                                }
                                            }, 5000);
                                            ...
                                            markers.add(mMap.addMarker(new MarkerOptions().position(requestLocationLatLng).title("Your Location").icon(BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_MAGENTA))));
                                            ...
                                            csllTaxiButton.setVisibility(View.INVISIBLE);
                ...
                if (lastKnownLocation != null) {
                    ...
                    request.saveInBackground(new SaveCallback() {
                        ...
                        public void done(ParseException e) {
                            if (e == null) {
                                csllTaxiButton.setText("Cancel Taxi");
                                requestActive=true;
...
if(requestCode==1){
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        csllTaxiButton=(Button) findViewById(R.id.callTaxiButton);
